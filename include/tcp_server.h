...
public:
     ...
     */
    TcpServer(frb::IOManager* worker = frb::IOManager::GetThis()
              ,frb::IOManager* io_woker = frb::IOManager::GetThis()
              ,frb::IOManager* accept_worker = frb::IOManager::GetThis());
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(frb::Address::ptr addr, bool ssl = false);
